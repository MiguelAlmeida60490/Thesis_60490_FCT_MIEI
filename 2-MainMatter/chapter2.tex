...
\chapter{NOVAthesis Template \emph{User's Manual}}\label{cha:users_manual}
...
\section{Quick Start}\label{sec:quick_started}

\subsection{With a Local \LaTeX\ Installation}\label{sub:with_a_local_latex_installation}
